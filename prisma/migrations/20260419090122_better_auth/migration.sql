/*
  ...
  - You are about to drop the `wish_items` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "contributions" DROP CONSTRAINT "contributions_wishItemId_fkey";

-- DropForeignKey
ALTER TABLE "occasions" DROP CONSTRAINT "occasions_userId_fkey";

-- DropForeignKey
ALTER TABLE "wish_items" DROP CONSTRAINT "wish_items_userId_fkey";
